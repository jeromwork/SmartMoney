...
или предварительно выполнить вход в слоте `mt4-test`.
...
Слоты терминалов в проекте называются `terminals/mt4-*` исторически, но текущий pipeline настроен на `MT5/MQL5`.
